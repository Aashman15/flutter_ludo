    ...
    for (int i = 0; i < 6; i++) {
      ...
      tableRows.add(
        TableRow(
          children: [
            MyTableCell(
                colIndex: 0, colPosition: firstColPosition, color: 'blue'),
            MyTableCell(
                colIndex: 1, colPosition: secondColPosition, color: 'blue'),
            MyTableCell(
                colIndex: 2, colPosition: thirdColPosition, color: 'blue'),
          ],
        ),
      );
    }
